...
async function mmGrant(){
  ...
  var req={chainId:'0x'+Number(mmCfg.chainId).toString(16),to:mmCfg.agent,permission:{type:'erc20-token-periodic',isAdjustmentAllowed:false,data:{tokenAddress:mmCfg.usdc,periodAmount:periodAmount,periodDuration:86400,justification:'Agent City may spend ≤5 USDC/day on your behalf (revocable).'}},rules:[{type:'expiry',data:{timestamp:expiry}}]};
  try{
